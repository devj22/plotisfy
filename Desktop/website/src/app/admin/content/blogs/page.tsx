      ...
      <div className="p-6 space-y-6 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl border border-[#E2DDD6] divide-y divide-[#F7F3ED]">
          ...
          {!loading && list.length === 0 && (
            <p className="p-8 text-center text-[#6B7B94]">No posts yet. Click "New post" to create one.</p>
          )}
        </div>
      </div>
...
function BlogEditorModal({
  ...
  const [author, setAuthor] = useState(blog?.author ?? "Plotzify");
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-2xl border border-[#E2DDD6] w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-xl">
        ...
        <div className="p-4 space-y-3">
          ...
          <label className="block text-sm">
            <span className="font-medium text-[#162338]">Slug (optional — auto-generated if blank)</span>
            <input
              value={slug}
